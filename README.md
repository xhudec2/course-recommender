...
### Features
- Syllabus refinement using `gpt-oss:20b-cloud`, which runs on [Ollama Cloud](https://ollama.com), to unify the language in the syllabi and make them of similar length for easier RAG.
